...
import blog1 from '../../img/blog/single_blog_1.png';
import blog2 from '../../img/blog/single_blog_2.png';
            ...
            <div className="row">
                <div className="col-lg-8 mb-5 mb-lg-0">
                    <div className="blog_left_sidebar">
                        ...
                        <article className="blog_item">
                            <div className="blog_item_img">
                                <img className="card-img rounded-0" src={blog2} alt="" />
                                <a href="#" className="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
                        ...
                        <article className="blog_item">
                            <div className="blog_item_img">
                                <img className="card-img rounded-0" src={blog3} alt="" />
                                <a href="#" className="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
                        ...
                        <article className="blog_item">
                            <div className="blog_item_img">
                                <img className="card-img rounded-0" src={blog4} alt="" />
                                <a href="#" className="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
                        ...
                        <article className="blog_item">
                            <div className="blog_item_img">
                                <img className="card-img rounded-0" src={blog5} alt="" />
                                <a href="#" className="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
